...
<html lang="en">
  ...
  <a class="navbar-brand" href="/adminDashboard">&nbsp;&nbsp;<i class="fa fa-hospital-o" style="font-size:48px;color:red"></i><br><b><font color="Red">IPTMS</font></b></a>
		...
		<div class="container-fluid">
				<hr></hr>
		<h1 class="text-center text-white">Treatment Plan</h1>
		<hr></hr>
			<div>
				  ...
				  <c:set var="count" value="${count + 1}" scope="page" />
				    <tr>
				      ...
				      <td>${plan.treatmentEndDate}</td>
				       <td><a title="claim-insurance" href='/claimInsurance?id=<c:out value="${plan.ptDetail.id}"></c:out>'>${plan.status}</a></td>
				    </tr>
				 </c:forEach>
				  </tbody>
				</table>
